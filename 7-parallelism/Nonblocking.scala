// :load fpinscala/parallelism/Actor.scala
...
object Nonblocking {
  ...
  // exercise 7.10: map2 doesn't handle errors at all. In case of exception,
  // latch never counts down and the exception is swallowed. Fix that.
}
